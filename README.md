...
Demonstrates accessing Wasm linear memory from JS and efficiency improvements offered by computing inner product in Wasm vs js.
...
RUSTFLAGS="-C link-args=--import-memory"  cargo build --release --target wasm32-unknown-unknown
